...
public class XMLQueryParser extends DefaultHandler {
	...
	public static List<?> execute(final String xmlQuery, final Session session) throws IOException, SAXException, HibernateException {
		if(xmlQuery==null || xmlQuery.trim().isEmpty()) throw new IllegalArgumentException("The passed XmlQuery was null or empty");
	 ...
	 */
	@SuppressWarnings({"unchecked"})
	public void startElement(String uri, String localNameX, String qName,
