 ...
 * <p><code>test.com.heliosapm.aa4h.JDBCHelper</code></p>
 */
...
public class JDBCHelper {
	...
	/**
	 * Maps the first two columns of the result set into a map
	 * @param sql The sql to execute
	 * @return the resulting map
	 */
	public Map<Object, Object> queryForMap(CharSequence sql) {
