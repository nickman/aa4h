 ...
 * @author WhiteheN
 * @version $Revision$ 
 * TODO: Need to re-evaluate this class and try to make it work with the specific Hibernate <code>Type</code> definitions.
 * TODO: Probably need to implement more datatypes, or figure out how to automate this along the lines of a <code>PropertyEditor<code>.
 */
